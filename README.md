...
* [DOS batch files to compile and run a Java program](http://alvinalexander.com/blog/post/java/dos-batch-files-compile-run-java-program-create-jar-file)
...
* [Installing Java Eclipse and Maven](https://www.youtube.com/watch?v=DLPjCZ5n_SM)
* [Maven Tutorial for Beginners : with Eclipse](https://www.youtube.com/watch?v=0CFWeVgzsqY)
...
* [Artifactory(jFrog)](https://www.jfrog.com/)
* [Nexus](https://www.sonatype.com/download-oss-sonatype)
* [Introduction to JFrog Artifactory](https://www.youtube.com/watch?v=5_b5UHUPE8s)
...
* [Gulp.js Build System](https://www.youtube.com/watch?v=LmdT2zhFmn4&list=PLv1YUP7gO_viROuRcGsDCNM-FUVgMYb_G) Part1,2 and 3
* [Integrate Gulp on a Maven managed project](https://samerabdelkafi.wordpress.com/2015/09/25/gulp-on-a-maven-managed-project/)
